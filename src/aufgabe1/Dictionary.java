...
public interface Dictionary<K, V> extends Iterable<Dictionary.Entry<K, V>>
{
	 ...
	 * specified value. Returns the previous value associated with key, or null if
	...
	/**
	 * Removes the key-vaue-pair associated with the key. Returns the value to which
	 * the key was previously associated, or null if the key is not contained in the
	 * dictionary.
	 * 
	...
	/**
	 * Returns an iterator over the entries in this dictionary. There are no
	 * guarantees concerning the order in which the elements are returned (unless
	 * this dictionary is an instance of some class that provides a guarantee).
	 * 
